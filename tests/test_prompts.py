...
def test_get_prompt_full():
    ...
    # Note: Ceiling covers memory read+write tool instructions plus MCP manifest CLI tool docs
    assert 500 < len_tokens(combined_content, "gpt-4") < 8900 + user_config_size
