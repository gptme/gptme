        ...
        for server_name, connection in self.servers.items():
            ...
            for mcp_tool in connection.client.tools[0].tools:
                ...
                tool_specs.append(ToolSpec(
                    ...
                    examples=getattr(mcp_tool, 'examples', [])
                ))
